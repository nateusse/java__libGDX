...
public class TextureNinja implements Screen {
    ...
    public TextureNinja() {
        ...
        texture = new Texture("tr_run.png");
        region = new TextureRegion(texture,   2, 4, 472, 457);  //in the atlas map it would be xy and size
    }
    ...
    public void render(float delta) {
        ...
        batch.draw(region,0,0,2,2); /*paint figure 0,0 an be 2X2*/
        batch.end();
